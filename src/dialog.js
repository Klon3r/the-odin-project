...
function addInputProjectDialog() {
  ...
  projectDialogAddButton.addEventListener("click", () => {
...
function addInputNoteDialog() {
  ...
  noteDialogAddButton.addEventListener("click", () => {
    addNote(noteDesc.value);
    closeNoteDialog();
  });
  noteDialogCancelButton.addEventListener("click", () => {
    closeNoteDialog();
  });
...
function addInputNoteEditDialog() {
  ...
  noteEditAddButton.addEventListener("click", () => {
    editNoteFromStorage(
      noteOldDesc.value,
      noteEditInput.value,
      noteLocationCounterDiv.value,
    );
    closeEditDialog();
  });
  noteEditCancelButton.addEventListener("click", () => {
    closeEditDialog();
  });
...
export function showEditDialog(desc, locationIndex) {
  ...
  const noteLocationCounter = document.getElementById(
    "note-location-counter-div",
  );
